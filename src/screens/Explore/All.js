...
const CategoryA = ({ darkMode }) => {
    // Sample data for items in Category A
    const items = [
        { id: 1, image: require('../../assets/item-a.png'), name: 'Item 1', price: '$100', rating: '4.5' },
        { id: 2, image: require('../../assets/item-b.png'), name: 'Item 2', price: '$120', rating: '4.8' },
        { id: 2, image: require('../../assets/item-c.png'), name: 'Item 2', price: '$120', rating: '4.8' },
        ...
        { id: 2, image: require('../../assets/item-g.png'), name: 'Item 2', price: '$120', rating: '4.8' },
        { id: 2, image: require('../../assets/item-h.png'), name: 'Item 2', price: '$120', rating: '4.8' },
        { id: 2, image: require('../../assets/item-b.png'), name: 'Item 2', price: '$120', rating: '4.8' },
        { id: 2, image: require('../../assets/item-a.png'), name: 'Item 2', price: '$120', rating: '4.8' },
