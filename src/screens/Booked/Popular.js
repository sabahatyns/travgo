...
const CategoryC = ({ darkMode }) => {
    // Sample data for items in Category D
    const items = [
        { id: 1, image: require('../../assets/item-e.png'), name: 'The Lalit New Delhi', price: '$100', rating: '4.5', location: ' Uttar Pradesh, India', reviews: 10 },
        { id: 2, image: require('../../assets/item-f.png'), name: 'Taj Mahal', price: '$120', rating: '4.8', location: ' Uttar Pradesh, India', reviews: 20 },
        { id: 3, image: require('../../assets/item-g.png'), name: 'The Lalit New Delhi', price: '$90', rating: '4.2', location: ' Uttar Pradesh, India', reviews: 15 },
        { id: 4, image: require('../../assets/item-h.png'), name: 'The Great Wall of China', price: '$150', rating: '4.6', location: ' San Francisco', reviews: 18 },
